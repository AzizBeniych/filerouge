...
<h1 id="BookType">Reading is food for the soul</h1>
	...
	<?php
		...
		$result = mysqli_query($con,"SELECT * FROM `book` LIMIT 9");
...
<footer class="FooterHome">
        ...
        <div id="FooterForm">
            ...
            <form action="" class="FooterForm" method="POST">
                <input type="Email" id="emailFooter" placeholder="example@example.com" name="emailfooter"><br>
                <input type="submit" id="footerButton" name="submit">
            </form>
        </div>
    </footer>
        <?php
	...
	// 	  session_start();
	// 	 $emaill = $_POST['emailfooter'];
	// 	 if (isset ($_POST['submit'])){


	// 		$sql = "INSERT INTO email (email) VALUES ($emaill) ";
